...
@endsection
@section('header-title', 'Create Feedback Draft')
    ...
    <div class="col-lg-12">
        <div class="statbox widget box box-shadow">
            <div class="widget-content widget-content-area">
                <form action="{{ route('feedbacks.draft.store') }}" method="post">
                    @csrf
                    <div id="content-container">
                        ...
                        <div class="form-group">
                            ...
                            <select class="custom-select @error('feedback_id') is-invalid @enderror" required
                                name="feedback_id[]" multiple>
                                @foreach ($feedbacks as $feedback)
                                <option value="{{ $feedback->id }}">{!! $feedback->question !!}</option>
                                @endforeach
                            </select>
                            @error('division_id')
                            <span class="invalid-feedback" role="alert">
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="summernote" required name="question"></textarea>
                            @error('question')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
